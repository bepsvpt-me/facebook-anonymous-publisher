...
class TextToImageTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_create_multiple_images()
    {
        $text = <<<'EOF'
...
EOF;
        ...
        $images = $this->textToImage->make($text, true);
...
EOF;
    ...
    {
        $this->textToImage->setFont(null);

        $this->assertNull($this->textToImage->getFontPath());

        $path = __DIR__.'/../src/fonts/NotoSansCJKtc-Regular.otf';
